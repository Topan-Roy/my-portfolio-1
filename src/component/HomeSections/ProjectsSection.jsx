...
const projects = [
  {
    id: 1,
    name: "Dine Five – Food Ordering Mobile App",
    duration: "30 days",
    image: "https://i.ibb.co.com/bMYqWS6x/Screenshot-20260621-011755.jpg",
    description: "A cross-platform food ordering application built with React Native and Expo, featuring a restaurant discovery flow, cart management, and location services.",
    problemSolved: "Solves remote food ordering and coordination with a smooth mobile interface and secure Stripe payment integration.",
    tech: ["React Native", "Expo", "TypeScript", "Zustand", "Stripe"],
  ...
  {
    id: 2,
    name: "Bhojon – Online Food Ordering & Delivery Platform",
    duration: "20 days",
    image: "https://i.ibb.co.com/spG1398s/bhojon.png",
    description: "A full-stack food ordering platform featuring dedicated Admin, User, and Delivery dashboards for real-time operations.",
    problemSolved: "Enables seamless restaurant order management using Firebase authentication, JWT authorization, and responsive UI.",
  ...
  {
    id: 3,
    name: "Book Shop – Full Stack E-Commerce Platform",
    duration: "12 days",
    image: "https://i.ibb.co.com/0RYjDT3h/Screenshot-2026-06-21-003226.png",
    description: "A full-stack online bookstore with secure user authentication, responsive book browsing, search, and ordering system.",
    problemSolved: "Helps users browse, wishlist, and purchase books with a smooth checkout flow and REST APIs.",
